...
namespace TestDomain
{
    public class ParkingContractTest
    {
        ...
        {
            ParkingContract parkingContract = ParkingContractFactory.MakeParkingContract(1,new Company("NameTest","XXXX", "EmailTest@hotmail.com"), DateTime.Now.AddHours(1), DateTime.Now.AddHours(1), 1);
        ...
        {
            ParkingContract parkingContract = ParkingContractFactory.MakeParkingContract(1,new Company("NameTest", "XXXX", "EmailTest@hotmail.com"), new DateTime(2022,12,31), DateTime.Now.AddHours(1), 1);
